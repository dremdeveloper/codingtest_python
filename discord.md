...
## 목차
1. [음성채널이란?](#1-음성채널이란)
2. [Discord 가입 및 설정](#2-Discord-가입-및-설정)
3. [음성채널에 접속하기](#3-음성채널에-접속하기)
4. [음성채널에서 할 수 있는 일](#4-음성채널에서-할-수-있는-일)
5. [모각코란?](#5-모각코란)
6. [문제 해결](#6-문제-해결)
...
| **모각코 참여 방법** | 음성채널에 접속하여 각자 공부나 코딩을 진행하면 됩니다. 혼자 공부하는 것보다 여러 사람과 함께 모여서 공부하면 더 집중할 수 있고, 동기부여가 될 수 있습니다. |
